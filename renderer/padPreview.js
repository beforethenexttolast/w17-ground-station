...
export function padPreviewSvg(presetKey) {
  ...
  const pill = (x, y, name) =>
    `<rect class="pp-pill" x="${x}" y="${y}" width="56" height="18" rx="5"/>` +
  ...
  return `<svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="controller layout preview">
    ${pill(46, 8, n.brake)}<text class="pp-role" x="110" y="21">BRAKE</text>
    ${pill(46, 32, n.gearDown)}<text class="pp-role" x="110" y="45">GEAR &#9660;</text>
    ${pill(298, 8, n.throttle)}<text class="pp-role" x="290" y="21" text-anchor="end">THROTTLE</text>
    ${pill(298, 32, n.gearUp)}<text class="pp-role" x="290" y="45" text-anchor="end">GEAR &#9650;</text>
    ...
    <circle class="pp-ctl" cx="275" cy="88" r="12"/>
    ${caption(275, 72, 'middle', 'DRS', n.drs)}
    <circle class="pp-ctl" cx="301" cy="114" r="12"/>
    ${caption(319, 118, 'start', 'BOOST', n.boost)}
    <circle class="pp-ctl" cx="249" cy="114" r="12"/>
