# w17-ground-station — Local Guidance (Codex)
...
parent `../AGENTS.md`; this file carries only repo-specific rules. Volatile
...
- Race day may **manage the mapper PROCESS** — start, liveness, stop
  ...
  `test/noControlPath.test.js:125-170` pins the process contract structurally; if a change
